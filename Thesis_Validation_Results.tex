...
\end{figure}
 ...
 \begin{figure}[h]
 	\begin{subfigmatrix}{2}
 		\subfigure[Sensitivity]{\includegraphics[width=0.49\linewidth]{Figures/metrics/Hepatitis-log-approach1-sensitivity.png}}
 		\subfigure[Specificity]{\includegraphics[width=0.49\linewidth]{Figures/metrics/Hepatitis-log-approach1-specificity.png}}
 		\subfigure[Precision]{\includegraphics[width=0.49\linewidth]{Figures/metrics/Hepatitis-log-approach1-precision.png}}
 		\subfigure[F-Measure]{\includegraphics[width=0.49\linewidth]{Figures/metrics/Hepatitis-log-approach1-fmeasure.png}}
 	\end{subfigmatrix}
 	\caption{Different metrics for the overall prognosis using logistic regression on the Hepatitis dataset.}
 	\label{fig:metricsregression}
 \end{figure}
